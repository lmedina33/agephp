...
<body>
<div class="indice">&nbsp;<img src="imagenes/p.gif" alt="p.gif" />&nbsp;<a href="configuracion.php" class="linkscentrales" title="Configuraci&oacute;n">Configuraci&oacute;n</a>&nbsp;<img src="imagenes/p.gif" alt="p.gif" />&nbsp;Apuntes y Pr&aacute;cticas</div><br />
<div class="textoinfo">
...
while($rowAnio = $result->fetchRow())
{
	...
	echo "<tr><td>";
	echo "<a class='linkscentrales' href='configarchivo.php?idCurso=$rowMateria[1]&amp;nombreMateria=$rowMateria[0]&amp;nombreAnio=$rowMateria[2]&amp;nombreNivel=$rowMateria[3]'  title='$rowMateria[0]'>";
	echo $rowMateria[0];
	echo "</a>";
	$permisoNecesario = "3".$rowMateria[1]; 
	if (canAccess($permisoNecesario))
	{
	echo "&nbsp;&nbsp;<img src=\"imagenes/decrypted.png\" align=\"middle\" />";
	}
	echo "<br />";
	echo "</td></tr>\n";
	}
